...
public class TestDBModel {
    ...
    public void testCreateRecord()
    {
        try
        {
        	// Used Code from Billionaire, should work?
            //assertTrue("Testing creation of player with id provided", db.createRecord(FIELD_NAMES, values));
